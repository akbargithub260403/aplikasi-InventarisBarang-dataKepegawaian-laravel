...
<div class="col">
    <div class="card">
        ...
        <form action="/add-admin/register" method="post" enctype="multipart/form-data" class="form-horizontal">
        @csrf
            <div class="row form-group">
                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama </label></div>
                <div class="col-12 col-md-9">
                    <input type="text" name="name" id="text-input" placeholder="Nama" class="form-control @error ('name') is-invalid @enderror" role="alert">
                    @error('name')
...
<hr>
        <div class="row form-group">
            <div class="col col-md-3"><label for="select" class=" form-control-label">Tipe Akun Admin</label></div>
                <div class="col-12 col-md-9">
        ...
        <div class="row form-group">
            <div class="col col-md-3">
                ...
                <div class="col-12 col-md-9">
                    <select name="prodi" id="select" class="form-control">
                    ...
                    <small class="form-text text-muted">Jika anda memilih tipe Akun sebagai <b>Super Admin</b> , anda tidak perlu memilih nama prodi</small>
                </div>
            </div>
